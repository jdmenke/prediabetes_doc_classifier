...
if __name__ == "__main__":
    ...
    for target in targets:
        for gran in granularity:
            ...
            model_name = f"{dirname}/scripts/document_classifier/term_freq_models/best_{target}_{gran}.joblib"
    ...
    log_file_loc = f"{dirname}/scripts/document_classifier/term_freq_models/log_performance.pickle"
